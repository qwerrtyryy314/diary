...
//        //FIXME:addtoolbar or smthng
//        helpMenu->addAction(tr("About"), this, SLOT(about()));
//        helpMenu->addAction(tr("About &Qt"), qApp, SLOT(aboutQt()));
//    }

    textEdit = new QTextEdit(this);//TODO: add everything from textedit example
...
bool TextEdit::load(const QString &f)
{
    ...
    QTextCodec *codec = Qt::codecForHtml(data);//TODO: codec for odt/rtf...
